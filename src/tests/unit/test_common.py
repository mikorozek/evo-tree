...
def are_subtrees_equal(
    tree1: DecisionTree, tree2: DecisionTree, idx1: int, idx2: int
) -> bool:
    """
...
def assert_subtree_unchanged(
    result: DecisionTree, original: DecisionTree, start_idx: int, excluded_idx: int
) -> bool:
    """
    ...
    return assert_subtree_unchanged(
        result, original, 2 * start_idx + 1, excluded_idx
    ) and assert_subtree_unchanged(result, original, 2 * start_idx + 2, excluded_idx)
